...
def enrich_discovery_jobs(rows: Iterable[dict]) -> list[dict]:
    ...
    Discovery records are curated and may become richer after a job was first saved.
    Applying that richer metadata at read time prevents stale SQLite/Postgres copies
    from continuing to under-score the role.
    """
